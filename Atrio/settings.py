...
MIDDLEWARE = [
    ...
    'apps.core.audit_context.AuditRequestMiddleware',
    'apps.core.shift_session.ShiftSessionMiddleware',
...
USE_I18N = True
USE_TZ = True
SHIFT_CHANGE_TIME_ZONE = os.getenv("SHIFT_CHANGE_TIME_ZONE", "America/Sao_Paulo")
